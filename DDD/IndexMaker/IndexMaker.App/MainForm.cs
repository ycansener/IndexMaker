...
namespace IndexMaker
{
    public partial class MainForm : Form
    {
        ...
        IDirectoryManagementService _service;
        public MainForm(IDirectoryManagementService service)
        {
            _service = service;
            InitializeComponent();
        ...
        private void buttonBrowse_Click(object sender, EventArgs e)
        {
            using (FolderBrowserDialog fbd = new FolderBrowserDialog())
            {
                ...
                if (dr.Equals(DialogResult.OK))
                {
                    ...
                    string name = _service.GetName(path);
        ...
        private void buttonStartListing_Click(object sender, EventArgs e)
        {
            ...
            _folderModel = _service.Investigate(_folderModel);
